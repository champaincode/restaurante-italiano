      ...
      >
        ...
        <motion.div style={{ opacity: heroOpacity }} className="relative z-10 text-center max-w-5xl px-6 w-full">
          ...
          <motion.h1
            ...
            style={{ fontSize: 'clamp(4rem, 12vw, 10rem)', lineHeight: 0.85, letterSpacing: '-0.02em' }}
          >
            Reservas
          </motion.h1>
          <motion.div
        ...
        >
          <span className="text-white/30 text-[10px] uppercase tracking-[0.3em]">Reservar</span>
          <motion.div
            animate={{ y: [0, 6, 0] }}
